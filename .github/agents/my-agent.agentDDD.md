...
.form-group.is-focused .form-control {
  outline: none;
  background-image: -webkit-gradient(linear, left top, left bottom, from(#98b4b7), to(#98b4b7)), -webkit-gradient(linear, left top, left bottom, from(#0086C8), to(#0086C8));
  background-image: -webkit-linear-gradient(#98b4b7, #98b4b7), -webkit-linear-gradient(#0086C8, #0086C8);
  background-image: -o-linear-gradient(#98b4b7, #98b4b7), -o-linear-gradient(#0086C8, #0086C8);
  background-image: linear-gradient(#98b4b7, #98b4b7), linear-gradient(#0086C8, #0086C8);
